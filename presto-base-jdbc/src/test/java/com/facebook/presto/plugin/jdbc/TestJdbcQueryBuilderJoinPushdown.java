...
//     Test what happens when you pass joinPushdownTables as empty
            ...
            throws SQLException
    {
        ...
        Connection connection = database.getConnection();
        try (PreparedStatement preparedStatement = new QueryBuilder("\"")
                .buildSql(jdbcClient, session, connection, "", "test_schema", "test_table_1",
                        Collections.emptyList(), columns1, tupleDomain, Optional.empty());
